...
# Проверка и обработка пустых значений в столбце 'Пользовательское поле (Story Points)'
df['Пользовательское поле (Story Points)'] = df['Пользовательское поле (Story Points)'].fillna(0)
#
...
# Автор: [Ваше имя]
# Версия: 1.0
>>>>>>> 212bc83f599293b4be988f2a9cc7bbb90827ac42
